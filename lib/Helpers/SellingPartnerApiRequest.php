...
//            exit();
     ...
     * @return mixed
     */
    private function sendRequestAsync(Request $request)
    {
        return $this->client
            ...
            ->then(
                ...
                function ($exception) {
                    ...
                    return [
                        'error'=>1,
                        'code' => $statusCode,
                        'msg'=> $statusCode.' Error connecting to the API (%s)'.$exception->getRequest()->getUri(),
                        'msg_data' => [
