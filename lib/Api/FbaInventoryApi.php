...
class FbaInventoryApi
{
     ...
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\FbaInventory\GetInventorySummariesResponse
     */
    ...
    {
        return $this->getInventorySummariesWithHttpInfo($granularity_type, $granularity_id, $marketplace_ids, $details, $start_date_time, $seller_skus, $next_token);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\FbaInventory\GetInventorySummariesResponse, HTTP status code, HTTP response headers (array of strings)
     */
