...
class ProductPricingApi
{
     ...
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\ProductPricing\GetPricingResponse
     */
    public function getCompetitivePricing($marketplace_id, $item_type, $asins = null, $skus = null)
    {
        return $this->getCompetitivePricingWithHttpInfo($marketplace_id, $item_type, $asins, $skus);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\ProductPricing\GetPricingResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\ProductPricing\GetOffersResponse
     */
    public function getItemOffers($marketplace_id, $item_condition, $asin)
    {
        return $this->getItemOffersWithHttpInfo($marketplace_id, $item_condition, $asin);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\ProductPricing\GetOffersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        return $this->getListingOffersWithHttpInfo($marketplace_id, $item_condition, $seller_sku);
    }
    ...
    {
        return $this->getPricingWithHttpInfo($marketplace_id, $item_type, $asins, $skus, $item_condition);
    }
