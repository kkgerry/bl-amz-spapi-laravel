...
class AuthorizationApi
{
    ...
    public function getAuthorizationCode($selling_partner_id, $developer_id, $mws_auth_token)
    {
        ...
        return $this->getAuthorizationCodeWithHttpInfo($selling_partner_id, $developer_id, $mws_auth_token);;
    }
     ...
     * @throws ApiException             on non-2xx response
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\Authorization\GetAuthorizationCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
