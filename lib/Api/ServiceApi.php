...
class ServiceApi
{
     ...
     *
     * @param \Kkgerry\AmazonSellingPartnerAPI\Models\Services\AddAppointmentRequest $body           Add appointment operation input details. (required)
     ...
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\Services\SetAppointmentResponse
     */
    public function addAppointmentForServiceJobByServiceJobId($body, $service_job_id)
    {
        return $this->addAppointmentForServiceJobByServiceJobIdWithHttpInfo($body, $service_job_id);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\Services\SetAppointmentResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\Services\CancelServiceJobByServiceJobIdResponse
     */
    public function cancelServiceJobByServiceJobId($service_job_id, $cancellation_reason_code)
    {
        return $this->cancelServiceJobByServiceJobIdWithHttpInfo($service_job_id, $cancellation_reason_code);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\Services\CancelServiceJobByServiceJobIdResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\Services\CompleteServiceJobByServiceJobIdResponse
     */
    public function completeServiceJobByServiceJobId($service_job_id)
    {
        return $this->completeServiceJobByServiceJobIdWithHttpInfo($service_job_id);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\Services\CompleteServiceJobByServiceJobIdResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\Services\GetServiceJobByServiceJobIdResponse
     */
    public function getServiceJobByServiceJobId($service_job_id)
    {
        return $this->getServiceJobByServiceJobIdWithHttpInfo($service_job_id);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\Services\GetServiceJobByServiceJobIdResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return \Kkgerry\AmazonSellingPartnerAPI\Models\Services\GetServiceJobsResponse
     */
    ...
    {
        return $this->getServiceJobsWithHttpInfo($marketplace_ids, $service_order_ids, $service_job_status, $page_token, $page_size, $sort_field, $sort_order, $created_after, $created_before, $last_updated_after, $last_updated_before, $schedule_start_date, $schedule_end_date);
    }
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Kkgerry\AmazonSellingPartnerAPI\Models\Services\GetServiceJobsResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param \Kkgerry\AmazonSellingPartnerAPI\Models\Services\RescheduleAppointmentRequest $body           Reschedule appointment operation input details. (required)
     * @param string                                                                         $service_job_id An Amazon defined service job identifier. (required)
    ...
    {
        return $this->rescheduleAppointmentForServiceJobByServiceJobIdWithHttpInfo($body, $service_job_id, $appointment_id);
    }
